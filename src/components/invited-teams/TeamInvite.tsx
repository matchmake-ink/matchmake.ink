...
export function TeamInvite({
  ...
  return (
    <div className="bg-background-dark flex flex-row max-w-lg border-slate-100 rounded-lg border m-2 p-2">
      <img
        src={teamLogoUrl}
        alt="Team Logo"
      ...
      <button
        className="bg-primary-500 p-2 m-2 rounded-lg hover:bg-primary-400 w-20 transition-all"
